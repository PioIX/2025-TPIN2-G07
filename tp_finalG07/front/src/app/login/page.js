        ...
        <>
            <div className={styles.body}>
                <div className={styles.container}>
                    ...
                    <Input  className={styles.inputLogin} tipo="login" placeholder="Nombre" value={nombre} onChange={modificarNombre}></Input>
                    <Input  className={styles.inputLogin} tipo="login" placeholder="Contraseña" value={contraseña} onChange={modificarContraseña}></Input>
